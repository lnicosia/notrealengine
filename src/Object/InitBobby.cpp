...
std::shared_ptr<GLObject> InitBobby(void)
{
  ...
  character->transform.move(mft::vec3(0.0f, -0.5f, 5.0f));
  ...
  head.transform.move(mft::vec3(0.125f, 1.0f, -0.1f));
  ...
  lowerLeftArm.setColor(mft::vec3(0.4f, 0.4f, 0.0f));
  ...
  lowerRightArm.setColor(mft::vec3(0.4f, 0.4f, 0.0f));
  lowerRightArm.transform.move(mft::vec3(0.0f, -1.0f, 0.0f));

  torso.addMesh(std::shared_ptr<Mesh>(new Mesh(GLContext::cube)));
  Mesh&	leftThigh = (*torso.getChildren()[3]);
  leftThigh.setName("Left thigh");
  leftThigh.setColor(mft::vec3(0.0f, 0.0f, 0.6f));
  leftThigh.transform.move(mft::vec3(0.0f, -0.5f, 0.0f));
  ...
  leftCalf.setColor(mft::vec3(0.0f, 0.0f, 0.2f));
  leftCalf.transform.move(mft::vec3(0.0f, -1.0f, 0.0f));

  torso.addMesh(std::shared_ptr<Mesh>(new Mesh(GLContext::cube)));
  Mesh& rightThigh = (*torso.getChildren()[4]);
  rightThigh.setName("Right thigh");
  rightThigh.setColor(mft::vec3(0.0f, 0.0f, 0.6f));
  rightThigh.transform.move(mft::vec3(0.65f, -0.5f, 0.0f));
